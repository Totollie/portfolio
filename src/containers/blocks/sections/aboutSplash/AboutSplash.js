                            ...
                            <div className="centered-box">
                                <TextEntry title={"About Me"}>
                                    <p style={{textAlign: "center", fontSize: "20px", margin: "20px"}}>
                                        ...
                                        requirements of the project and I am flexible to its needs.<br/><br/>I am
                                        also a
                                        full-time student, in my third year of a degree towards MEng Computer
                                        Science,
                                        having taken a year out working as a research intern.<br/><br/>Take a look
                                        at
                                        the skills I have acquired below!<br/>
                                        <a style={{display: "block", fontSize: "20px", margin: "10px"}}
                                           href="#skills">Go >></a>
                                    </p>
                                </TextEntry>
                            </div>
