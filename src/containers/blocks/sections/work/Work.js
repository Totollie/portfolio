...
import {Media, PageHeader, Row, Well} from "react-bootstrap";
                ...
                <Row>
                    <Media>
                        ...
                        <Media.Body>
                            ...
                            <blockquote style={{fontSize: "0.9em", color: "#999", marginBottom: "0"}}>
                                This is a personal recommendation, not endorsed by the University of Southampton. Oliver
                                worked on the 5G-ENSURE project for 3 months in 2016. He was the main developer of an
                                advanced web user interface using ReactJS to create a drag and drop network diagram.
                                Oliver worked in a team, collaborating on the RESTful API design, making effective use
                                of GitLab and communicating well.
                                <footer>Dr. Stephen Phillips - Principal Research Engineer and Project Coordinator
                                </footer>
                            </blockquote>
                            <blockquote style={{fontSize: "0.9em", color: "#999", marginBottom: "0"}}>
                                A true team player, Oliver contributed considerably to our software development. He was
                                working on the JS front-end of our application and his solid coding skills helped us in
                                releasing on time. I would not hesitate to work with him again.
                                <footer>Dr. Stefanie Cox - Research Engineer</footer>
                            </blockquote>
                        </Media.Body>
                    </Media>
                </Row>
